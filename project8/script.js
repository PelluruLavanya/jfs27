...
function display()
{
  ...
  let returnVal = Table.reduce(function(acc,obj,id)
  {
      let tr=`                                     
      <tr>
          <td>${obj.id}</td>
...
function add()
{
  ...
  let id=idEle.id;
  let title =titleEle.title;
  let price=priceEle.title;
  let description=descriptionEle.description;
  let category=categoryEle.category;
  let rating=ratingEle.rating;
...
function edit(id)
{
 ...
 let obj=Task[id];
 idEle.value=obj.id;
 titleEle.value=obj.title;
 priceEle.value=obj.price;
 descriptionEle.value=obj.description;
 categoryEle.value=obj.category;
 ratingEle.value=obj.rating;
}
...
const Add = ()=>{
  ...
  let descriptionV=document.getElementById('descrition').value=''
  let categoryV=document.getElementById('category').value=''
  let imageV=document.getElementById('image').value=''
  let ratingV=document.getElementById('rating').value=''
  if(idV==""||titleV==""||priceV==""||descriptionV==""||categoryV==""||imageV==""||ratingV==""){
...
const editItem=(id)=>{
 ...
 let ratingkEle = document.getElementById('rating')
}
 ...
 if(task){
  idEle.value=id.id
  titleEle.value = title.title
  priceEle.value=price.price
  descriptionEle.value = description.time
  categoryEle.value=category.task
  imageEle.value = image.image
  ratingEle.value=rating.rating
...
const edit = (id)=>{
 ...
 console.log(taskV,timeV)
  ...
  if(task){
      ...
      task.title=titleV,
      task.price=priceV,
      task.description=descriptionV,
      task.category=categoryV,
      task.image=imageV,
      task.rating=ratingV
  }
  display()
